...
export const attendances = {
  // (전 api 명) attendance
  postAttendances: (studyId: number, studyScheduleId: number) => ({
    url: `${process.env.NEXT_PUBLIC_BASE_URL}/studies/${studyId}/schedules/${studyScheduleId}/attendances`,
    method: Method.POST,
  }),
  // (전 api 명) editAttendance
  putAttendances: (studyId: number, studyScheduleId: number) => ({
    url: `${process.env.NEXT_PUBLIC_BASE_URL}/studies/${studyId}/schedules/${studyScheduleId}/attendances`,
    method: Method.PUT,
  }),
  getAttendances: (studyId: number) => ({
    url: `${process.env.NEXT_PUBLIC_BASE_URL}/studies/${studyId}/members/attendances`,
    method: Method.GET,
  }),
  // (전 api 명) earlyLeave
  patchAttendances: (studyId: number, studyScheduleId: number) => ({
